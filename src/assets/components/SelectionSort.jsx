        ...
        <div className='sort-container'>
            ...
            <div className='sort-definition'>
                ...
                <p><strong>Analogy to Sorting:</strong><br />
                    Think of selection sort as sorting a deck of cards by repeatedly finding the smallest card from the unsorted portion and swapping it with the leftmost unsorted card. This process gradually builds up the sorted portion of the deck.</p>

                <p><strong>Selection Sort Algorithm:</strong></p>
                <p>To implement selection sort:</p>
                <ol>
                ...
                <p><strong>Example:</strong><br />
                    Consider sorting an array [5, 2, 1, 9, 6] using selection sort:
                    <ul>
